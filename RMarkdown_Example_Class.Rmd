...
output:
  html_document:
    ...
    toc_float: yes
---
Note that I added a table of contents compared to the class version. 

If you have some packages you want to load, you can do them here (instead of doing it further down right before we plot something.) This is helpful for reproducibility.
